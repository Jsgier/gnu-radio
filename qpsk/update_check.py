...
class update_check(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "update_check")
        ...
        self._freq_offset_range = qtgui.Range(-500e-3, 500e-3, 100e-3, 0, 200)
...
def main(top_block_cls=update_check, options=None):
